...
namespace AppCode.Data
{
  ...
  /// Most properties have a simple access, such as `.DoNotDeleteWarning`. <br/>
...
namespace AppCode.Data.AutoGenerated
{
  ...
  {
    /// <summary>
    /// DoNotDeleteWarning as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("DoNotDeleteWarning", scrubHtml: true) etc.
    /// </summary>
    public string DoNotDeleteWarning => _item.String("DoNotDeleteWarning", fallback: "");

    /// <summary>
    /// TestPopup as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("TestPopup", scrubHtml: true) etc.
    /// </summary>
    public string TestPopup => _item.String("TestPopup", fallback: "");
  }
}