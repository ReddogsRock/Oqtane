...
namespace AppCode.Data.AutoGenerated
{
  ...
  public abstract class ZagViewConfiguration: Custom.Data.CustomItem
  {
    ...
    /// <summary>
    /// SortOrderName as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("SortOrderName", scrubHtml: true) etc.
    /// </summary>
    public string SortOrderName => _item.String("SortOrderName", fallback: "");

    /// <summary>
    /// SortOrderPriority as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("SortOrderPriority", scrubHtml: true) etc.
    /// </summary>
    public string SortOrderPriority => _item.String("SortOrderPriority", fallback: "");
